...
public class Drivetrain extends SubsystemFramework{
	...
	private VictorSPX rightSlaveMotor;
	private VictorSPX leftSlaveMotor;
	...
	public Drivetrain(WPI_TalonSRX rightMasterMotor, VictorSPX rightSlaveMotor, VictorSPX rightSlaveMotor2,
					  WPI_TalonSRX leftMasterMotor, VictorSPX leftSlaveMotor, VictorSPX leftSlaveMotor2, 
					  doubleSolenoid shifter, ADXRS450_Gyro SpartanBoard, 
					  double Average_Ticks_Per_Feet, double Turn_ANGLE_Kp, double Turn_ANGLE_Ki,
	...
	public void autoDriveStraight(double amtToDrive){
		...
		myRobot.arcadeDrive(Drive_PI.getControlledOutputP(goal_Ticks_Error), Drive_Angle_PI.getOutputP(goal_Angle_Error));
	}
	...
	public double getPosition(){
		return ((-1*rightMasterMotor.getSelectedSensorPosition(0) + leftMasterMotor.getSelectedSensorPosition(0)) / 2);
	}
	...
	/*	Reset SpartanBoard
	 *	When Current Robot Angle is outside (-360, 360)
	 */
	...
	public void setupSensors() {
		...
		rightSlaveMotor2.set(ControlMode.Follower, rightMasterMotor.getDeviceID());
